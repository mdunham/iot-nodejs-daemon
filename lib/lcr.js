        ...
        self.getTransaction = function(callback) {
                ...
                return lcRequest.issue([lcFlags.lcrMethods.GET_TRANSACTION], (status, response) => {
                        let
                                data        = response.data,
                                returnCode  = data.substr(0,2),
				temp        = data.substr(2, 8),
				customerId  = data.substr(10, 8),
				saleNumber  = data.substr(18, 8),
				gross       = data.substr(26, 8),
				net         = data.substr(34, 8),
				statusCode  = data.substr(42, 4),
                                compType    = data.substr(46, 2),
                                dateFormat  = data.substr(48, 2),
                                decimals    = data.substr(50, 2),
                                product     = data.substr(52, 2),
                                qtyUnits    = data.substr(54, 2),
                                tempScale   = data.substr(56, 2),
                                dateTime    = data.substr(58, 24),
				record = {
